...
class Gui:
    ...
    def menu1(self):
        ...
        display.button_with_text(display.screen, (30, 60, 300, 120), (223, 169, 191), (223, 169, 151), 10, 2, "deszcz", 80, (253, 50, 35))
        display.button_with_text(display.screen, (30, 220, 300, 120) , (216, 155, 43), (216, 155, 0), 10, 2, "dripper", 80, (253, 50, 35))
        display.button_with_text(display.screen, (360, 60, 300, 120) , (187, 179, 41), (187, 179, 0), 10, 2, "oswietlenie", 75, (253, 50, 35))
        display.button_with_text(display.screen, (360, 220, 300, 120) , (213, 0, 88), (213, 0, 38), 10, 2, "wentylacja", 75, (253, 50, 35))
        ...
        display.button_with_text(display.screen, (690, 390, 100, 80), (120, 120, 120), (15, 15, 15), 10, 2, "<", 120, (0, 0, 0))
        pygame.display.update()
