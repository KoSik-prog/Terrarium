...
class Gui:
    ...
    def menu_sprayer_tab(self):
        ...
        display.label_center(display.screen, "ilość dziś:", "Nimbus Sans L", 40, 700, 175, (253, 201, 77), 255)
    ...
    def menu_terrarium_tab(self):
        ...
        myTop = 20
        display.label_center(display.screen, "Min wilgotność ", "Nimbus Sans L", 48, 210, myTop+40, (253, 180, 165), 255)
        ...
        myTop += 110
        display.label_center(display.screen, "Temperatura na wyspie", "Nimbus Sans L", 47, 210, myTop+40, (253, 180, 165), 255)
        ...
        myTop += 110
        display.label_center(display.screen, "minimalne UVI", "Nimbus Sans L", 48, 210, myTop+23, (253, 180, 165), 255)
        display.label_center(display.screen, "dla ogrzewania ", "Nimbus Sans L", 50, 220, myTop+60, (253, 180, 165), 255)
